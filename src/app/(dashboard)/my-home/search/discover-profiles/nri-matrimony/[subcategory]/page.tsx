...
export default function NriSubcategoryResultsPage() {
  ...
  function queryFn(
    ...
    return supabase
      ...
      .neq("id", profileId)
      .eq("gender", gender)
      .neq("profile_location_info.residing_country", "India")
      .eq("profile_location_info.residing_country", name)
  ...
  return (
    <CategoryResultsPage
      ...
      queryFn={queryFn}
      categoryHref="/my-home/search/discover-profiles/nri-matrimony"
    />
  );
}
