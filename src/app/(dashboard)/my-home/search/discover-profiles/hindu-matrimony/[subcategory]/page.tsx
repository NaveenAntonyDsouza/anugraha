...
export default function HinduSubcategoryResultsPage() {
  ...
  function queryFn(
    ...
    return supabase
      ...
      .neq("id", profileId)
      .eq("gender", gender)
      .eq("profile_religious_info.religion", "Hindu")
      .eq("profile_religious_info.caste_community", name)
  ...
  return (
    <CategoryResultsPage
      ...
      queryFn={queryFn}
      categoryHref="/my-home/search/discover-profiles/hindu-matrimony"
    />
  );
}
