...
export default function SecondMarriageSubcategoryResultsPage() {
  ...
  function queryFn(
    ...
    return supabase
      ...
      .neq("id", profileId)
      .eq("gender", gender)
      .eq("profile_primary_info.marital_status", name)
  ...
  return (
    <CategoryResultsPage
      ...
      breadcrumbs={[
        ...
        { label: "Second Marriage Matrimony", href: "/my-home/search/discover-profiles/second-marriage-matrimony" },
        { label: name + " Brides", href: "#" },
      ]}
      queryFn={queryFn}
      categoryHref="/my-home/search/discover-profiles/second-marriage-matrimony"
    />
  );
}
