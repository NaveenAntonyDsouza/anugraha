...
export default function JainSubcategoryResultsPage() {
  ...
  function queryFn(
    ...
    return supabase
      ...
      .neq("id", profileId)
      .eq("gender", gender)
      .eq("profile_religious_info.religion", "Jain")
      .eq("profile_religious_info.jain_sect", name)
  ...
  return (
    <CategoryResultsPage
      ...
      queryFn={queryFn}
      categoryHref="/my-home/search/discover-profiles/jain-matrimony"
    />
  );
}
