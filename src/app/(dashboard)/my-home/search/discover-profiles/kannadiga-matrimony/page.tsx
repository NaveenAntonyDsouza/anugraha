...
export default function KannadigaMatrimonyPage() {
  function queryFn(
    ...
    return supabase
      ...
      .neq("id", profileId)
      .eq("gender", gender)
      .eq("profile_primary_info.mother_tongue", "Kannada")
  ...
  return (
    <CategoryResultsPage
      title="Kannadiga Brides"
      breadcrumbs={[
        { label: "My Home", href: "/my-home" },
        { label: "Discover Profiles", href: "/my-home/search/discover-profiles" },
        { label: "Kannadiga Brides", href: "#" },
      ]}
      queryFn={queryFn}
      categoryHref="/my-home/search/discover-profiles/kannadiga-matrimony"
    />
  );
}
