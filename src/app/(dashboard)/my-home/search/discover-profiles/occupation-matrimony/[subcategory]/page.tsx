...
export default function OccupationSubcategoryResultsPage() {
  ...
  function queryFn(
    ...
    return supabase
      ...
      .neq("id", profileId)
      .eq("gender", gender)
      .eq("profile_education_profession.occupation_category", name)
  ...
  return (
    <CategoryResultsPage
      ...
      queryFn={queryFn}
      categoryHref="/my-home/search/discover-profiles/occupation-matrimony"
    />
  );
}
