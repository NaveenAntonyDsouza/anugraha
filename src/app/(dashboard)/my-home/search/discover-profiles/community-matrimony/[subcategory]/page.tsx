...
export default function CommunitySubcategoryResultsPage() {
  ...
  function queryFn(
    ...
    return supabase
      ...
      .neq("id", profileId)
      .eq("gender", gender)
      .eq("profile_religious_info.denomination", name)
  ...
  return (
    <CategoryResultsPage
      ...
      queryFn={queryFn}
      categoryHref="/my-home/search/discover-profiles/community-matrimony"
    />
  );
}
